...
from FAST_API.src.routes import contacts, auth, users
...
app.mount("/static", StaticFiles(directory="FAST_API/src/static"), name="static")
...
templates = Jinja2Templates(directory="FAST_API/src/templates")


@app.get("/", response_class=HTMLResponse)
async def index(request: Request):
    return templates.TemplateResponse('index.html', {'request': request, 'our': 'First FastApi Project'})
